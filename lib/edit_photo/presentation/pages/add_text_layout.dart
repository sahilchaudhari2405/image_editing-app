            ...
            child: TextButton(
              onPressed: () {
                ...
                var result = DragableWidgetTextChild(
                  ...
                  fontFamily: _valueListener.value.fontFamily,
                );
          ...
          Positioned(
            ...
            child: SizedBox(
              ...
              child: ValueListenableBuilder<DragableWidgetTextChild>(
                ...
                builder: (context, value, _) {
                  return ListView(
                    padding: EdgeInsets.only(right: mq.width * .0500),
                    ...
                    children: fonts.map((font) {
                      return GestureDetector(
                        onTap: () {
                          print(font);
                          print(_valueListener.value.fontFamily);
                          _valueListener.value =
                              _valueListener.value.copyWith(fontFamily: font);
                        },
                        child: Container(
                          height: 40,
                          width: 40,
